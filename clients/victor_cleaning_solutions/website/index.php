      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
            ...
            <p><a href="#" class="btn btn-primary mr-md-4 py-2 px-4">Get a free estimate <span class="ion-ios-arrow-forward"></span></a></p>
          </div>
        </div>
      </div>
    </div>
    		...
    		<div class="row d-flex no-gutters">
    				...
    				<div class="img d-flex align-items-center justify-content-center py-5 py-md-0" style="background-image:url(images/about.jpg);">
    					<div class="time-open-wrap">
			              ...
			              <div class="opening-hours">
			              	<h4>Opening Days:</h4>
			              	<p class="pl-3">
			              		<span><strong>Monday – Sunday:</strong> 24/7</span>
			              		<span><strong>We never close</strong></span>
			              	</p>
			              	<h4>We work on:</h4>
			              	<p class="pl-3">
    			...
    			<div class="col-md-6 pl-md-5 pt-md-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <p>Provide excellent cleaning
services of the highest quality
that excess our clients’
expectations through
innovation, training and the
commitment of our employees,
enduring that every space
become a safe, clean, and
healthy environment</p>
		          ...
		          <div class="col-md-6 col-lg-4 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18">
		              ...
		              <div class="text">
		              	<span>Cleaning <br>Services</span>
		              </div>
		            </div>
		          </div>
		        </div>
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url(images/work-1.jpg);">
            	...
            	<div class="desc w-100 px-4 text-center pt-5 mt-5">
	              <div class="text w-100 mb-3 mt-4 text-center">
	              	<h2><a href="images/work-1.jpg" class="image-popup">House Cleaning</a></h2>
	              </div>
              </div>
            </div>
          </div>
